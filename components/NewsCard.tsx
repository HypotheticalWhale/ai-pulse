...
export function NewsCard({ article }: { article: Article }) {
  ...
  return (
    <a
      ...
      className="flex flex-col h-full focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-xl"
    >
      <Card className="flex flex-col h-full hover:shadow-lg transition-all duration-200 overflow-hidden group cursor-pointer">
